...
export const affiliations: Affiliation[] = [
  ...
  {
    id: 'cta',
    en: 'Southern California Council of Chinese Schools',
    zhHant: '南加州中文學校聯合會',
    roleEn: 'President, 1986; two years',
    roleZhHant: '1986年任會長，任期兩年',
    factId: 'teachers-association',
    logoPermitted: false,
    permissionNote:
      'Name as printed on the council\'s own 2006 certificate. Its round seal appears on that certificate; no clean asset found, and she held office there rather than founding it — ask the council before using it.',
  },
  {
    id: 'capta',
    en: 'Chinese American Parents and Teachers Association of Southern California',
    zhHant: '南加州華裔家長教師協會',
    roleEn: 'President, 1989',
    roleZhHant: '1989年任會長',
    factId: 'capta-president',
    logoPermitted: false,
    permissionNote: 'No mark found. The only visual is a hand-lettered event banner.',
  },
  {
    id: 'shih-chien',

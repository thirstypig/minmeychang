...
export const timeline: TimelineEvent[] = [
  ...
  },
  {
    id: 'sccs-president',
    year: 1986,
    en: 'President of the Southern California Council of Chinese Schools, a post she holds for two years.',
    zhHant: '任南加州中文學校聯合會會長，任期兩年。',
    factId: 'teachers-association',
  },
  {
    id: 'festival-arboretum',
    year: 1987,
    en: 'With the Arcadia Chinese Association, organizes a two-day Chinese cultural festival at the Los Angeles County Arboretum.',
    zhHant: '與亞凱迪亞華人協會於洛杉磯郡植物園主辦為期兩天的中華文化活動節。',
  ...
  },
  {
    ...
    zhHant: '與亞凱迪亞華人協會於杭廷頓圖書館與花園主辦為期兩天的中華文化活動節。',
    factId: 'culture-festivals',
  },
  {
    id: 'capta-president',
    year: 1989,
    en: 'Installed as President of the Chinese American Parents and Teachers Association of Southern California.',
    zhHant: '就任南加州華裔家長教師協會會長。',
